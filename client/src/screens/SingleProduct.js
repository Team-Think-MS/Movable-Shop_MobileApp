      ...
      <View style={{ marginBottom: 80, padding: 5 }}>
        <View>
          ...
          <Pressable
            ...
            onPress={() => {
              props.addToWishList(item), console.log(props);
            }}
          >
        ...
        <View style={styles.view13}>
          {item.stockQty > 0 ? (
            <View>
              ...
              <TouchableOpacity
                onPress={() => {
                  props.addItemToCart(item, count),
...
const mapDispatchToProps = (dispatch) => {
  return {
    addItemToCart: (product, count) => {
      dispatch(actions.addToCart({ quantity: count, product }));
    },
...
const styles = StyleSheet.create({
  ...
  view17: { alignItems: "center", padding: 10, backgroundColor: "white" },
