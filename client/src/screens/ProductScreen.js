...
const ProductScreen = ({ navigation, route }) => {
  ...
  const getProducts = () => {
    axios
      .get(`http://192.168.8.123:3002/api/products/store/${item.storeId}`)
      .then((products) => {
        ...
        <FlatList
          ListHeaderComponent={
            <>
              ...
              <Pressable
                onPress={() => {
                  navigation.navigate("Customer Reviews", { item: item });
                }}
              >
                {/** <Rating
        rating={item.rating}
          ...
          renderItem={({ item, index }) => (
            ...
            >
              <View style={styles.productCardTwo}>
                ...
                >
                  <Text style={styles.productCardTextTwo}>Rs.{item.price}</Text>
                </View>
              </View>
            </Pressable>
          )}
